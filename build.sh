...
_main_repo="$_root_dir/chromium-build-system"

# For packaging
_chromium_version=$(cat "$_root_dir"/chromium_version.txt)
_ungoogled_revision=$(cat "$_root_dir"/chromium-build-system/revision.txt)
...
chrome/installer/mac/pkg-dmg \
  ...
  --target "$_root_dir/build/chromium-build-system_${_chromium_version}-${_ungoogled_revision}.${_package_revision}_macos.dmg" \
